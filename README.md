...
> Answer: The main advantage to client-side routing is that it allows us to build a single-page web application with navigation without the page refreshing as the user navigates. 
